...
urlpatterns = [
    ...
    path('new_call_history', create_call, name="new_call_history"),
    #####
    ...
    path('all_calls', show_all_calls_history, name="all_calls"),
    #####
    ...
    path('update_call_history/<int:call_id>', update_call, name="update_call_history"),
    #####
    ...
    path('delete_call_history/<int:call_id>', delete_call, name="delete_call_history"),
]